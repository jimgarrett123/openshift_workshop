...
....
$ oc new-project myjbossapp-<your-username> --display-name="My JBoss Applications" --description="A place for my JBoss EAP Applications"
....
...
In the upper left corner click on the triangle next to *Administrator*, then select the *Developer* option.

image:images/developer.png[developer.png]

The *Developer* panel should display on the right.  In this panel you'll see a variety of ways to add images to the project.  Click on the *From Catalog* option.

image:images/from_catalog.png[from_catalog.png]


In the *Filter by keyword* box type `eap` and select the
'JBoss EAP 7.2' for this builder image.

image:images/jboss_eap_72.png[from_catalog.png]
...
....
$ oc project myjbossapp-<your-username>
$ oc get builds
...
NAME      HOST/PORT                                             PATH      SERVICES   PORT      TERMINATION   WILDCARD
ks        ks-myjbossapp.apps.cbtss-bce5.openshiftworkshop.com             ks         <all>                   None
...
....
$ curl http://ks-myjbossapp.apps.cbtss-bce5.openshiftworkshop.com
...
Go to http://ks-myjbossapp.apps.cbtss-bce5.openshiftworkshop.com via your browser.
Please replace with the route associated with your application.
